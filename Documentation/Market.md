...
```python
response = market.categories.mihoyo.params()
print(response.json())
```
...
```python
response = market.categories.mihoyo.games()
print(response.json())
```
...
```python
response = market.categories.riot.params()
print(response.json())
```
...
```python
response = market.categories.riot.games()
print(response.json())
```
...
```python
response = market.categories.telegram.params()
print(response.json())
```
...
```python
response = market.categories.telegram.games()
print(response.json())
```
...
```python
response = market.categories.supercell.params()
print(response.json())
```
...
```python
response = market.categories.supercell.games()
print(response.json())
```
...
```python
response = market.categories.wot.params()
print(response.json())
```
...
```python
response = market.categories.wot.games()
print(response.json())
```
...
```python
response = market.categories.tiktok.params()
print(response.json())
```
...
```python
response = market.categories.tiktok.games()
print(response.json())
```
...
```python
response = market.categories.instagram.params()
print(response.json())
```
...
```python
response = market.categories.instagram.games()
print(response.json())
```
...
```python
response = market.categories.battlenet.params()
print(response.json())
```
...
```python
response = market.categories.vpn.params()
print(response.json())
```
...
```python
response = market.categories.vpn.games()
print(response.json())
```
